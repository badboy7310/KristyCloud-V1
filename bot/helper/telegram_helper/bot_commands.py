...
class _BotCommands:
    def __init__(self):
        ...
        self.QbMirrorCommand = getCommand('QBITMIR_BOT', f'qbmir{BOT_NO}')
        self.QbUnzipMirrorCommand = getCommand('QBITUNZIP_BOT', f'qbunzipmir{BOT_NO}')
        self.QbZipMirrorCommand = getCommand('QBITZIP_BOT', f'qbzipmir{BOT_NO}')
